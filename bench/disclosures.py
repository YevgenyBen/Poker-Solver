...
REGISTRY = (
    ...
    Disclosure(
        "STREET_ISOLATION_NOTE", "M304", ENGINE,
        ("STREET_ISOLATION_SPR_MIN", "STREET_ISOLATION_SPR_MAX",
         "STREET_ISOLATION_ROWS", "STREET_ISOLATION_GAP_MEAN",
         "STREET_ISOLATION_CATEGORICAL", "STREET_ISOLATION_CLOSE",
         "STREET_ISOLATION_CLOSE_LEVEL", "STREET_ISOLATION_MORE_AGGRESSIVE",
         "STREET_ISOLATION_COST_BB", "STREET_ISOLATION_COST_WORST",
         "STREET_ISOLATION_COST_OVER_ONE"),
        study="bench/studies/street_isolation.py"),
    Disclosure(
