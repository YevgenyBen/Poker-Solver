...
_ADVISE_ITERATION_CAPS = {
    ...
    ("turn", True): (
        ...
        (cfg.MAX_MULTIWAY_TURN_STANDALONE_ITERATIONS
         if cfg.MULTIWAY_TURN_SOLVE_STANDALONE
         else cfg.MAX_MULTIWAY_TURN_PATH_QUERY_FLOP_ITERATIONS),
    ),
    ("river", False): (cfg.DEFAULT_RIVER_PATH_QUERY_ITERATIONS, cfg.MAX_RIVER_PATH_QUERY_ITERATIONS),
    # M264: standalone gets its own measured budget; chained keeps its own.
    ("river", True): (
        (cfg.MULTIWAY_RIVER_STANDALONE_ITERATIONS
         if cfg.MULTIWAY_RIVER_SOLVE_STANDALONE
         else DEFAULT_FLOP_TO_RIVER_MULTIWAY_ITERATIONS),
        (cfg.MAX_MULTIWAY_RIVER_STANDALONE_ITERATIONS
         if cfg.MULTIWAY_RIVER_SOLVE_STANDALONE
         else cfg.MAX_FLOP_TO_RIVER_MULTIWAY_ITERATIONS),
    ),
}
