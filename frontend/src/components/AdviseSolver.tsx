                ...
                <>
                  <div className="detail-row">
                    <span className="bar-track">
                      <span
                        className="bar-fill"
                        style={{ width: '100%', background: gradientFor(result.hero.strategy) }}
                      />
                    </span>
                    <span className="breakdown">
                      {sortedEntries(result.hero.strategy)
          ...
          {combos.map((combo) => {
            ...
            return (
              <div className="detail-row" key={combo}>
                ...
                {!isTrained && (
                  <span className="trained-indicator untrained" title="Not enough data — the untrained default">
                    low data
                  </span>
                )}
              </div>
