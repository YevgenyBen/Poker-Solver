...
- **THE ENGINE CANNOT BET LESS THAN 2.5x THE POT, and it costs +0.0863 bb
  ...
  **Caveats**: split-half replicates in direction but not tightly in
  ...
  so the gain is the tail; and every benchmarked facing-a-bet spot is
  "facing a 2.5x bet", so advice when facing a SMALL bet is still
  generated by no benchmark.
