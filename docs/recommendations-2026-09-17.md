...
| **A4b** | **Give the solver a starting strategy that does not weight betting by how many bet sizes exist** | M264 | With one sized bet, multiway advice reaches the card-blind prior; with three, 80% of the starting mass is aggressive and under-converged rows keep it | OPEN |
